...
public class LeaderBoard extends Activity implements MaxAdViewAdListener
{
    ...
    ListView mListView;
    TextView leaderBoardHeading,scnd_position_text,scnd_position_score,first_position_text,first_position_score,third_position_text,third_position_score;
    TextView leaderBoardFooter;
    ProgressDialog dialog;
    LinearLayout adContainer,titlelistview;
    ScrollView scrollViewParent;

    ImageView casytxt_img, star1st, star2nd, star3rd;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
       ...
       // leaderBoardHeading = findViewById(R.id.leaderBoardHeading);
        ...
        casytxt_img = findViewById(R.id.casytxt_img);
        star1st = findViewById(R.id.star1st);
        star2nd = findViewById(R.id.star2nd);
        star3rd = findViewById(R.id.star3rd);
